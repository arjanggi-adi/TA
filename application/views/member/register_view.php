<div class="hero">
  <div class="hero__inner">
    <div class="container">
      <div class="hero__row">
        <h1 class="hero__header">Register</h1>
      ...
      <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <small> Email anda digunakan untuk memastikan keamanan akun anda, termasuk otorisasi dan akses pemulihan akun. </small>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-sm-3">Tempat Lahir <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <input type="text" class="form-control" name="mem_name" placeholder="tempat lahir" value="">
          </div>
        </div>
        <div class="form-group">
            ...
            <div class="form-inline">
              ...
              <div class="form-group">
                <select name="yyyy" class="form-control">
                  ...
                  <option value="20 05">2005 </option>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <label><input name="gender" type="radio" value="Male" checked>Laki-laki</label>   
            <label><input name="gender" type="radio" value="Female">Perempuan</label>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Nomer Ponsel <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
              <input type="text" class="form-control" name="contactnum" id="contactnum" placeholder="nomer ponsel anda." value="">
            </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-xs-offset-3 col-md-8 col-sm-9">
            <span class="text-muted">
              ...
              <a href="<?php echo base_url(); ?>member/access">Saya sudah memiliki akun?</a>
            </span>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel">
        <div class="panel-body">
          ...
          echo form_open("member/access/register", $attributes); ?>
          <div class="form-group">
            <label class="control-label">Nama</label>
            <input class="form-control" name="nama" placeholder="Nama lengkap" type="text" value="<?php echo set_value('nama'); ?>" />
          ...
          <div class="form-group">
            <button name="submit" type="submit" class="btn btn-danger">Signup</button>
            <button name="cancel" type="reset" class="btn btn-default">Cancel</button>
            <a href="<?php echo site_url(); ?>member/access">Saya sudah punya akun!</a>
          </div>
          <?php echo form_close(); ?>
